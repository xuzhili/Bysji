package com.example.xuzhili.bysjstudio.fragment;
...
import com.example.xuzhili.bysjstudio.Constants;
...
import com.example.xuzhili.bysjstudio.adapter.PictureScrollPagerAdapter;
import com.example.xuzhili.bysjstudio.bean.ArticleItme;
import com.example.xuzhili.bysjstudio.bean.UnivsDataBase;
import com.example.xuzhili.bysjstudio.util.ResourceUtil;
...
public class ArticlePageFragment extends Fragment {
                    ...
                    public void onSuccess(int statusCode, String content) {
                        ...
                        if (isAdded()) {
                            ...
                            if (ss != null && ss.isState()) {
                                ...
                                imageViews = pictureScrollPagerAdapter.getImages();
    ...
    public ImageView getImageView() {
        if (imageViews == null || imageViews.size() < head_img.getCurrentItem() + 1) return null;
        return imageViews.get(head_img.getCurrentItem());
    }
}
