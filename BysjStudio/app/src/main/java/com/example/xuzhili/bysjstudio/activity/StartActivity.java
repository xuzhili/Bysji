...
import com.example.xuzhili.bysjstudio.bean.Splash;
                ...
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(String content) {
                        ...
                        Splash splash = (Splash) ParseUtils.Gson2Object(
                                content, tp);
                        try {
                            Splash.App app = splash.getData().getApp();
...
//		Builder builer = new Builder(getApplicationContext());
