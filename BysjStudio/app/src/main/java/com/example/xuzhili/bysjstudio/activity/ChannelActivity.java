...
import com.example.xuzhili.bysjstudio.adapter.DragAdapter;
import com.example.xuzhili.bysjstudio.adapter.OtherAdapter;
...
public class ChannelActivity extends AppCompatActivity implements OnItemClickListener,
    ...
    private void initNaigation(String json) {
        ...
        if (mUnivsDataBase != null && mUnivsDataBase.isState()) {
            ...
            userGridView.setonExchangelistenter(new DragGrid.Exchangelistenter() {
