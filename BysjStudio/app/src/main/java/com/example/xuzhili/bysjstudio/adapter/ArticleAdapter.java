...
import com.example.xuzhili.bysjstudio.bean.Type;
...
public class ArticleAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.d("ArticleAdapter:Type:", new Type(item.getModelid()).toString());
        Log.d("ArticleAdapter:Type:-----id:", item.getModelid() + "");
