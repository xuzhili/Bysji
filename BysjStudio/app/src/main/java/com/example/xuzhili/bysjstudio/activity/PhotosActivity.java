...
import com.example.xuzhili.bysjstudio.DownloadWebImgTask;
...
import com.example.xuzhili.bysjstudio.adapter.PhotosActivityAdapter;
import com.example.xuzhili.bysjstudio.bean.ArticleItme;
import com.example.xuzhili.bysjstudio.bean.PhotosItem;
...
//            .getUMSocialService("com.umeng.share");
    ...
    private void setListData(PhotosItem.PhotoData data) {
        ...
        ArrayList<PhotosItem.ImageData> images = data.getImages();
        ...
        listview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                PhotosItem.ImageData item2 = adapter.getItem(position - 1);
