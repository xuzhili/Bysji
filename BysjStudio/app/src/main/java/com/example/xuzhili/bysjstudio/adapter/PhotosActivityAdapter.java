...
public class PhotosActivityAdapter extends BaseAdapter {
	...
	private ArrayList<PhotosItem.ImageData> imagedata = new ArrayList<PhotosItem.ImageData>();
	...
	public void addData(ArrayList<PhotosItem.ImageData> imagedata) {
	...
	@Override
	public PhotosItem.ImageData getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		PhotosItem.ImageData item = getItem(position);
